...
public class CatastropheReportCommandImpl {
	...
	public String run() {
		...
		String message = MessageBuilder.build("Liferay Inc.", divisibleValues);
	...
	private long processUser(User user) throws PortalException, SystemException {
		_log.debug("User Name: " + user.getFullName());
		List<Organization> organizations = user.getOrganizations();
		long organizationId = _strategy.chooseOneOf(organizations).getOrganizationId();
	...
	private static Log _log = LogFactoryUtil
			.getLog(CatastropheReportCommandImpl.class);
