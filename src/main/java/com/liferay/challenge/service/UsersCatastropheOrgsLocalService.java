...
/**
 * Provides the local service interface for UsersCatastropheOrgs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UsersCatastropheOrgsLocalServiceUtil
...
public interface UsersCatastropheOrgsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link UsersCatastropheOrgsLocalServiceUtil} to access the users catastrophe orgs local service. Add custom service methods to {@link com.liferay.challenge.service.impl.UsersCatastropheOrgsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
